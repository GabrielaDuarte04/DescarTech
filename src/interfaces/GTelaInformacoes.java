...
public class GTelaInformacoes extends javax.swing.JFrame {

    public GTelaInformacoes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfaces/7GIF Informacoes.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GTelaInformacoes().setVisible(true);
            }
        });
    }
