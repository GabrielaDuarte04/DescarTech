...
public class TelaSuporte extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cxTxt.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        cxTxt.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 12)); // NOI18N
        jScrollPane1.setViewportView(cxTxt);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 540, 520, 80));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfaces/8GIF Suporte.gif"))); // NOI18N
